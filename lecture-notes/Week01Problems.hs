...
removeStyle (Text t) = Text t
removeStyle (Bold t) = removeStyle t
removeStyle (Italic t) = removeStyle t
removeStyle (Concat t1 t2) = Concat (removeStyle t1) (removeStyle t2)
...
markupToHTML (Text t) = htmlEscape t
markupToHTML (Bold t) = "<strong>" ++ markupToHTML t ++ "</strong>"
markupToHTML (Italic t) = "<em>" ++ markupToHTML t ++ "</em>"
markupToHTML (Concat t1 t2) = markupToHTML t1 ++ markupToHTML t2
